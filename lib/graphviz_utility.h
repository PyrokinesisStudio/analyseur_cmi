...
public:
    ...
    void AddEdge(int from_id, int to_id, std::string label, std::string options);
...
inline GraphvizUtility::GraphvizUtility(bool directed)
{
    m_directed = directed;
}

inline GraphvizUtility::~GraphvizUtility()
{
}

inline void GraphvizUtility::AddNode(int id, std::string label, std::string options)
{
    RemoveNode(id);
...
inline void GraphvizUtility::EditNode(int id, std::string label, std::string options)
{
...
inline void GraphvizUtility::RemoveNode(int id)
{
    std::map<int,struct GraphvizNode>::iterator it;
    it = m_nodes.find(id);
...
inline void GraphvizUtility::AddEdge(int from_id, int to_id, std::string label, std::string options)
{
...
inline void GraphvizUtility::RemoveEdges(int id_1, int id_2)
{
    RemoveEdgesDirected(id_1, id_2);
    RemoveEdgesDirected(id_2, id_1);
}

inline void GraphvizUtility::RemoveEdgesDirected(int from_id, int to_id)
{
    unsigned int x = 0;
...
inline void GraphvizUtility::Export(std::string filename)
{
...
inline void GraphvizUtility::ClearGraph()
{
    m_nodes.clear();
}
